        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdditionNotes = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SittingTableId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SittingTable", x => x.SittingTableId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Product_Sitting_CategoryID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReservationSittingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ReservationID = table.Column<int>(type: "int", nullable: false),
                    SittingTableID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservationSitting", x => x.ReservationSittingId);
                    table.ForeignKey(
                        name: "FK_ReservationSitting_Reservation_ReservationID",
                        column: x => x.ReservationID,
                        principalTable: "Reservation",
                        principalColumn: "ReservationId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReservationSitting_SittingTable_SittingTableID",
                        column: x => x.SittingTableID,
                        principalTable: "SittingTable",
                        principalColumn: "SittingTableId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationSitting_ReservationID",
                table: "ReservationSitting",
                column: "ReservationID");

            migrationBuilder.CreateIndex(
                name: "IX_ReservationSitting_SittingTableID",
                table: "ReservationSitting",
                column: "SittingTableID");
        }
